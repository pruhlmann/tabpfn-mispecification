"""Task-specific config for the 2D Gaussian-mixture custom task.

dim_theta = dim_x = 2. Well-specified posterior is the "eight gaussians on a
circle" (closed-form). Misspecification: anchors on an ellipse (axis_ratio != 1).
"""
...
def get_config():
    ...
    config.task = "gaussian_mixture_2d"
